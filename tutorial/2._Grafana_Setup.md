...
11. Here is another example showing how to add a blue clock.

<img src="./assets/grafana_13.png" alt="grafana dashboard setup">

12. Remember to set the update interval to anything but `OFF`. Select `Auto` or match it with the Prometheus update interval.

<img src="./assets/grafana_14.png" alt="grafana dashboard setup">

13. Star the repository, for quicker access from the frontpage. 
