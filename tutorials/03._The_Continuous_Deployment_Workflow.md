...
While the network has been defined correctly in the `compose.prod.yaml` file, this information does not carry over when building the individual images. 
...
It might offer some insight into the different parts. 