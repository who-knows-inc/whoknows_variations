...
**Note**: The images are private by default. You can change this by choosing a package and clicking `⚙️ Package settings` on the right side. In the Danger Zone there is a an option called: `Change package visibility`.